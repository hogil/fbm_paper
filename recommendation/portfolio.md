...
학습 코드 (`_train_chip_variant.py::grid_complete`) 의 GRID=8 / 50%-cell 덮어쓰기 + black-fill paired mask 를 실제 chip 이미지에 적용한 결과 (1행 4열):

| chip A: scratch | chip B: scratch_rot | FCM mixed (A+B) | Pair Mask (A-only) |
|:---------------:|:-------------------:|:---------------:|:------------------:|
| <img src="./figures/fcm_pm_step_a.png" width="160" /> | <img src="./figures/fcm_pm_step_b.png" width="160" /> | <img src="./figures/fcm_pm_step_mixed.png" width="160" /> | <img src="./figures/fcm_pm_step_masked.png" width="160" /> |

FCM 은 A 위에 B 의 8×8 격자 절반을 덮어쓴 mixed chip, Pair Mask 는 FCM 에서 B 가 들어간 자리만 검정으로 가린 paired augmentation chip (A label 만으로 학습) 입니다.
